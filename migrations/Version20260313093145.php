 ...
 */
final class Version20260313093145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS PasswordHistory (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, password_hash LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_141801F268D3EA09 (User_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE PasswordHistory DROP FOREIGN KEY FK_141801F268D3EA09');
        $this->addSql('ALTER TABLE PasswordHistory CHANGE password_hash password_hash VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE PasswordHistory ADD CONSTRAINT `FK_141801F268D3EA09` FOREIGN KEY (user_id) REFERENCES PasswordHistory (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
